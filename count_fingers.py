...
def countFingers(image, hand_landmarks, handNo=0):
    if hand_landmarks:
       ...
       totalFingersDown = fingersDown.count(1)

       text = f'Dedos Levantados: {totalFingers}'
       textFingersDown = f'Dedos Abaixados: {totalFingersDown}'

       cv2.putText(image, text, (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 2)
       cv2.putText(image, textFingersDown, (50,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
